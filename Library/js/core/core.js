(function (namespace, $) {
	...
	p._initDatePicker = function () {
		...
		$('input[name=datepicker]').datepicker({autoclose: true, todayHighlight: true});
	};
	...
	// =========================================================================
	namespace.addEmployee = new addEmployee;
...
function GetArrayByName( name ){
	var data=[];
	$('input[name="'+name+'"]').each(function(){data.push(this.value)})
	return data;
}
